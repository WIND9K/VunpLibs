...
from .http_client import make_sync_client          # ✅ bổ sung import đúng
...
def users_by_ids(
    ...
    # headers được xây mỗi lần gọi, không cache/hard-code
    with make_sync_client(http2=http2, timeout_s=timeout_s) as client:
        r = client.get(url, headers=build_headers(s), params=params)
        r.raise_for_status()
